...
handle.textContent = 'Hej Francesco;)';
...
closeButton.textContent = 'Var Inte Rädd nu>:)';
...
header.textContent = 'Skriv QUIZ id här;)';
...
header2.textContent = 'FRUKTA MIG FRANCESCO';
...
pointsLabel.textContent = 'Points per Question: Hej på dig>:)';
...
autoAnswerLabel.textContent = 'Jag vet vart du bor francy...';
...
header4.style.textShadow = `
  -1px -1px 0 rgb(47, 47, 46),
  1px -1px 0 rgb(47, 47, 49),
  -1px 1px 0 rgb(47, 47, 43),
  1px 1px 0 rgb(47, 47, 45)
`;
